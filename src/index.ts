...
function extractStructuredJsonObjectText(text: string): string | undefined {
...
function buildFocusEntryCompletionMetadata(text: string, triggerKind?: string | null): string {
